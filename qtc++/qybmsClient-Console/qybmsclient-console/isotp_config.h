...
/* Max payload Size of a Message(buffer) to be sent or received from a CAN-TP stack
 * 
*/
#define ISO_TP_MAX_PAYLOAD_SIZE     4095

/* Max number of messages the receiver can receive at one time, this value 
 * is affectied by can driver queue length
 */
#define ISO_TP_DEFAULT_BLOCK_SIZE   (255)
